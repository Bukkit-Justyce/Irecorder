...
public class JExtractAudio extends JDialog {
	 ...
	 * @param o 
	 */
	public JExtractAudio(Options o) {
		setResizable(false);
		...
		{
			JLabel lbl1 = new JLabel("Audio Format :");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						name=name.substring(0, name.lastIndexOf("."))+"Audio";
						String out = Files.LoadFromFile(null, null, null);
						if(out==null){ return;}
						Separator.extractAudio(path, out+name+aF);
						dispose();
					}
				});
